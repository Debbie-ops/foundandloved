...
"[project]/app/our-story/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OurStoryPage.useEffect": ()=>{
            const observer = new IntersectionObserver({
                "OurStoryPage.useEffect": (entries)=>{
                    entries.forEach({
                        "OurStoryPage.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                setVisibleSections({
                                    "OurStoryPage.useEffect": (prev)=>new Set(prev).add(entry.target.id)
                                }["OurStoryPage.useEffect"]);
                            }
                        }
                    }["OurStoryPage.useEffect"]);
            ...
            elements.forEach({
                "OurStoryPage.useEffect": (element)=>observer.observe(element)
            }["OurStoryPage.useEffect"]);
            return ({
                "OurStoryPage.useEffect": ()=>observer.disconnect()
            })["OurStoryPage.useEffect"];
        }
    }["OurStoryPage.useEffect"], []);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                children: [
                    ...
                    STORY_SECTIONS.map((section)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
_s(OurStoryPage, "k17gYjhph9yD3y46odqM5M+mazg=", false, function() {
    return [
...
//# sourceMappingURL=_29c5c1ec._.js.map